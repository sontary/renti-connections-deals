...
async function notifyPrimaryAdmin(auth, message){
  ...
  try{
    ...
    const html = `<div style="font-family:Arial,sans-serif;font-size:13px;line-height:1.6;color:#243128;max-width:560px;">
      ...
      <p style="margin:16px 0 0;color:#5c675e;font-size:11.5px;">Manage this under Me → Suggestions in the portal.</p>
    </div>`;
...
export default async (req) => {
  ...
  const notified = await notifyPrimaryAdmin(auth, message);
